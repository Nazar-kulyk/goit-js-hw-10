...
searchCountry.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearchCountry, DEBOUNCE_DELAY));
function onSearchCountry(e) {
    (0, _createMarkup.resetMarkup)();
    const nameCountry = e.target.value.trim();
    if (nameCountry === "") return;
    (0, _fetchCountries.fetchCountries)(nameCountry).then(onSuccess).catch(onError);
}
function onError() {
...
function onSuccess(data) {
    if (data.length > 10) {
        ...
        return;
    } else if (data.length === 1) (0, _createMarkup.createMarkup)(data);
    else (0, _createMarkup.createPrewiewMarkup)(data);
}

},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","./js/createMarkup":"dMjm4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/fetchCountries.":"gQz3c"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"dMjm4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createPrewiewMarkup(countries) {
...
function createMarkup(countries) {
    const markup = countries.map(({ name , capital , population , flags , languages  })=>{
      ...
      <li><p class = "coutry-info-text"><b>Languages:</b> ${Object.values(languages)}</p></li>
      </ul></div>`;
    }).join("");
    const refs = getRefs();
...
},{}],"gQz3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
